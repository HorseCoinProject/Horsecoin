...
uint256 hashGenesisBlock("0xe2fd0d9a7366e1465a19c5d1ea7bb2c9d8a651cf1994528bd79cb1fa91f27f0d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // HorseCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "HorseCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight < 500)   
    {
		...
		int rand = generateMTRandom(seed, 50000);
	...
	else
	{
		...
		int rand = generateMTRandom(seed, 500000);
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal HorseCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HorseCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2014 - Year of the Horse";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 88 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040124710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1393620164;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 11369010;
        ...
        assert(block.hashMerkleRoot == uint256("0x4c812d32aa8a9bc89fa60a93275a60f2fd43f0b7af4f75caab4c08a478967848"));
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc1, 0xa6, 0xcb }; // HorseCoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // HorseCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
