...
static const int64 MAX_MONEY = 92000000000 * COIN; // HorseCoin: maximum of 205M coins (given some randomness)
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // HorseCoin: 1440 blocks found a day. Priority cutoff is 1 HorseCoin day / 250 bytes.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("040184710fa689ad5013690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9")))
